...
public interface BagInterface<T>
{
	 ...
	 * @return true if the bas is full, or false if not */
	public boolean isFull();
	
	/** See whether the bag is empty.
	 * @return true if the bas is empty, or false if not */
	...
	/** Removes on occurrence of a given entry from this bag, if possible.
